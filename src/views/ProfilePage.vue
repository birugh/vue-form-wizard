                    ...
                    <div class="flex flex-row gap-1">
                        <div class="flex-row gap-1 w-120">
                            ...
                            <small class="flex flex-wrap gap-2">
                                <Tag v-for="zone in onboarding.access_rights.specific_zones" :key="zone" :value="zone"
                                    severity="info" />
                            </small>
                        </div>
                        ...
                        <div class="flex-row gap-1">
                            <p>Technical Tools</p>
                            <small class="flex flex-wrap gap-2">
                                <Tag v-for="tool in onboarding.access_rights.technical_tools" :key="tool" :value="tool"
                                    severity="success" />
                            </small>
